 ...
 * @author Dennis
 */
public class Game1_Screen extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Adult.setBackground(new java.awt.Color(255, 255, 255));
        Adult.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Adult.setText(" ");
        Adult.setOpaque(true);
        Adult.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentShown(java.awt.event.ComponentEvent evt) {
                AdultComponentShown(evt);
            }
        });
        add(Adult, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 230, 210));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        ImageIcon guessPic = new ImageIcon(getClass().getResource("/GameImages/" + subject + "A" + quest + ".png"));
    ...
    private void AdultComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_AdultComponentShown
        // TODO add your handling code here:
    }//GEN-LAST:event_AdultComponentShown
